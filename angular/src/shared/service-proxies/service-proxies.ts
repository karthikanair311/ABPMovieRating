...
export class ActorServiceProxy {
    ...
    /**
     * @param actorGender (optional) 
     * @return Success
     */
    getAll(actorGender: string | null | undefined): Observable<ActorListDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Actor/GetAll?";
        if (actorGender !== undefined && actorGender !== null)
            url_ += "ActorGender=" + encodeURIComponent("" + actorGender) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ActorListDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ActorListDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ActorListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ActorListDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ActorListDtoListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    createActor(body: CreateActorInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Actor/CreateActor";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    updateActor(body: UpdateActorInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Actor/UpdateActor";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    deleteActor(actorName: string | null | undefined, actorGender: string | null | undefined, id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Actor/DeleteActor?";
        if (actorName !== undefined && actorName !== null)
            url_ += "ActorName=" + encodeURIComponent("" + actorName) + "&";
        if (actorGender !== undefined && actorGender !== null)
            url_ += "ActorGender=" + encodeURIComponent("" + actorGender) + "&";
        if (id === null)
...
export class MovieServiceProxy {
     ...
     * @return Success
     */
    createMovie(body: CreateMovieInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Movie/CreateMovie";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateMovie(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
     ...
     * @return Success
     */
    addMovieCast(body: AddMovieCastInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Movie/AddMovieCast";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddMovieCast(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddMovieCast(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processAddMovieCast(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    updateMovie(body: UpdateMovieInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Movie/UpdateMovie";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateMovie(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    deleteMovie(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Movie/DeleteMovie?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteMovie(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
     ...
     * @return Success
     */
    getMovieItems(genre: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<MovieListDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Movie/GetMovieItems?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMovieItems(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMovieItems(<any>response_);
                } catch (e) {
                    return <Observable<MovieListDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<MovieListDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetMovieItems(response: HttpResponseBase): Observable<MovieListDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MovieListDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<MovieListDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    getMovieDetails(id: number | undefined): Observable<FullMovieDetailsListDto> {
        let url_ = this.baseUrl + "/api/services/app/Movie/GetMovieDetails?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMovieDetails(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMovieDetails(<any>response_);
                } catch (e) {
                    return <Observable<FullMovieDetailsListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<FullMovieDetailsListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetMovieDetails(response: HttpResponseBase): Observable<FullMovieDetailsListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = FullMovieDetailsListDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<FullMovieDetailsListDto>(<any>null);
    }
}
...
export class RatingServiceProxy {
     ...
     * @return Success
     */
    getRating(): Observable<RatingListDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Rating/GetRating";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<RatingListDtoListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<RatingListDtoListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetRating(response: HttpResponseBase): Observable<RatingListDtoListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RatingListDtoListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<RatingListDtoListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    createRating(body: CreateRatingInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Rating/CreateRating";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreateRating(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ActorListDto implements IActorListDto {
    actorName: string | undefined;
    actorGender: string | undefined;
    id: number;

    constructor(data?: IActorListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.actorGender = _data["actorGender"];
            this.id = _data["id"];
        }
    }

    static fromJS(data: any): ActorListDto {
        data = typeof data === 'object' ? data : {};
        let result = new ActorListDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["actorGender"] = this.actorGender;
        data["id"] = this.id;
        return data; 
    }
...
export class ActorListDtoListResultDto implements IActorListDtoListResultDto {
    items: ActorListDto[] | undefined;

    constructor(data?: IActorListDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(ActorListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ActorListDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ActorListDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ActorListDtoListResultDto {
        const json = this.toJSON();
        let result = new ActorListDtoListResultDto();
        result.init(json);
        return result;
...
export interface IActorListDtoListResultDto {
    items: ActorListDto[] | undefined;
}

export class CreateActorInput implements ICreateActorInput {
    actorName: string;
    actorGender: string;

    constructor(data?: ICreateActorInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateActorInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateActorInput();
        result.init(data);
        return result;
    }
...
export class UpdateActorInput implements IUpdateActorInput {
    actorName: string;
    actorGender: string;
    id: number;

    constructor(data?: IUpdateActorInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateActorInput {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateActorInput();
        result.init(data);
        return result;
    }
...
export class CreateMovieInput implements ICreateMovieInput {
    ...
    constructor(data?: ICreateMovieInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateMovieInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateMovieInput();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["releaseDate"] = this.releaseDate ? this.releaseDate.format('YYYY-MM-DD') : <any>undefined;
        return data; 
    }

    clone(): CreateMovieInput {
        const json = this.toJSON();
        let result = new CreateMovieInput();
        result.init(json);
        return result;
...
export class AddMovieCastInput implements IAddMovieCastInput {
    movieId: number;
    actorId: number;

    constructor(data?: IAddMovieCastInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AddMovieCastInput {
        data = typeof data === 'object' ? data : {};
        let result = new AddMovieCastInput();
        result.init(data);
        return result;
    }
...
export interface IAddMovieCastInput {
    movieId: number;
    actorId: number;
}

export class UpdateMovieInput implements IUpdateMovieInput {
    title: string;
    genre: string;
    releaseDate: moment.Moment;
    id: number;

    constructor(data?: IUpdateMovieInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateMovieInput {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateMovieInput();
        result.init(data);
        return result;
    }
...
export class MovieListDtoPagedResultDto implements IMovieListDtoPagedResultDto {
    totalCount: number;
    items: MovieListDto[] | undefined;

    constructor(data?: IMovieListDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): MovieListDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new MovieListDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): MovieListDtoPagedResultDto {
        const json = this.toJSON();
        let result = new MovieListDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IMovieListDtoPagedResultDto {
    totalCount: number;
    items: MovieListDto[] | undefined;
}
...
export class RatingListDto implements IRatingListDto {
    ...
    constructor(data?: IRatingListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): RatingListDto {
        data = typeof data === 'object' ? data : {};
        let result = new RatingListDto();
        result.init(data);
        return result;
    }
...
export interface IRatingListDto {
    reviewComments: string | undefined;
    reviewStar: number;
    movieId: number;
    creatorUser: UserDto;
...
export class FullMovieDetailsListDto implements IFullMovieDetailsListDto {
    title: string | undefined;
    genre: string | undefined;
    releaseDate: moment.Moment;
    isReviewed: boolean;
    ...
    constructor(data?: IFullMovieDetailsListDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["movieRatings"])) {
                ...
                for (let item of _data["movieRatings"])
                    this.movieRatings.push(RatingListDto.fromJS(item));
            }
            if (Array.isArray(_data["castList"])) {
                this.castList = [] as any;
                for (let item of _data["castList"])
                    this.castList.push(ActorListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): FullMovieDetailsListDto {
        data = typeof data === 'object' ? data : {};
        let result = new FullMovieDetailsListDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.movieRatings)) {
            ...
            for (let item of this.movieRatings)
                data["movieRatings"].push(item.toJSON());
        }
        if (Array.isArray(this.castList)) {
            data["castList"] = [];
            for (let item of this.castList)
                data["castList"].push(item.toJSON());
        }
        return data; 
    }

    clone(): FullMovieDetailsListDto {
        const json = this.toJSON();
        let result = new FullMovieDetailsListDto();
        result.init(json);
        return result;
...
export interface IFullMovieDetailsListDto {
    title: string | undefined;
    genre: string | undefined;
    releaseDate: moment.Moment;
    isReviewed: boolean;
...
export class RatingListDtoListResultDto implements IRatingListDtoListResultDto {
    items: RatingListDto[] | undefined;

    constructor(data?: IRatingListDtoListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(RatingListDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): RatingListDtoListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new RatingListDtoListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): RatingListDtoListResultDto {
        const json = this.toJSON();
        let result = new RatingListDtoListResultDto();
        result.init(json);
        return result;
...
export class CreateRatingInput implements ICreateRatingInput {
    ...
    constructor(data?: ICreateRatingInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateRatingInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateRatingInput();
        result.init(data);
        return result;
    }
