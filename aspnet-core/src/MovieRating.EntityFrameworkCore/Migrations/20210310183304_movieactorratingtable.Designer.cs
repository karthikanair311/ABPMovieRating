...
namespace MovieRating.Migrations
{
    ...
    [Migration("20210310183304_movieactorratingtable")]
    partial class movieactorratingtable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MovieRating.ActorInfo.ActorDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MovieRating.MovCast.MovieCast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MovieRating.RatingInfo.RatingDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MovieRating.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MovieRating.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MovieRating.MovCast.MovieCast", b =>
                {
                    b.HasOne("MovieRating.ActorInfo.ActorDetails", "ActorDetails")
                        .WithMany()
