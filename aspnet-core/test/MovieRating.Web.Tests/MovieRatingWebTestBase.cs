...
using MovieRating.Models.TokenAuth;
...
{
    public abstract class MovieRatingWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MovieRatingWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MovieRatingWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MovieRatingDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MovieRatingDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MovieRatingDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MovieRatingDbContext, Task<T>> func)
        {
            T result;
